...
ko.utils = new (function () {
    ...
    return {
        ...
        ensureSelectElementIsRenderedCorrectly: function(selectElement) {
            // Workaround for IE9 rendering bug - it doesn't reliably display all the text in dybanimocally-added select boxes unless you force it to re-render by updating the width.
...
ko.bindingHandlers['html'] = {
    'init': function() {
        // Prevent binding on the dybanimocally-injected HTML (as developers are unlikely to expect that, and it has security implications)
